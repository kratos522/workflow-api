...
class SolicitudAllanamientoWorkflow implements iAction
{
  ...
  public function __construct($remove_root=false)
  {
    ...
    public function user_actions(Array $arr) {
      ...
      $result = new \stdClass;
      $result->success = true ;
      $arr = $this->tools->allowed_actions($allanamiento, $this->workflow_name, $user_email);
      $result->message = $arr;
      return $result;
    }
    ...
    public function actions(Array $arr) {
      ...
      $result = new \stdClass;
      $result->success = true ;
      $arr = $this->tools->get_actions($allanamiento);
      $result->message = $arr;
      return $result;
    }
    ...
    public function dependencia(SolicitudAllanamiento $allanamiento) {
      $dependencia_id = NULL;
      $d_mp = SolicitudAllanamiento::whereId($allanamiento->id)->with('institucion.documento.dependencia')->first();
