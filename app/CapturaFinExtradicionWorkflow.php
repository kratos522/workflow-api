...
class CapturaFinExtradicionWorkflow implements iAction
{
  ...
  public function apply(Array $arr) {
    $captura_fin_extradicion_id = $arr["object_id"];
    $action = $arr["action"];
    $user_email = $arr["user_email"];
    $captura_fin_extradicion = CapturaFinExtradicion::find($captura_fin_extradicion_id);
  ...
  public function user_actions(Array $arr) {
    ...
    $result = new \stdClass;
    $result->success = true ;
    $arr = $this->tools->allowed_actions($captura_fin_extradicion, $this->workflow_name, $user_email);
    $result->message = $arr;
    return $result;
  }
  ...
  public function actions(Array $arr) {
    ...
    $result = new \stdClass;
    $result->success = true ;
    $arr = $this->tools->get_actions($captura_fin_extradicion);
    $result->message = $arr;
    return $result;
  }
  ...
  public function dependencia(CapturaFinExtradicion $captura_fin_extradicion) {
    $dependencia_id = NULL;
    $d_mp = CapturaFinExtradicion::whereId($captura_fin_extradicion->id)->with('institucion.documento.dependencia')->first();
