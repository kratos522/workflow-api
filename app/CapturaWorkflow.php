...
class CapturaWorkflow implements iAction
{
  ...
  public function __construct($remove_root=false)
  {
    ...
    $this->workflow_name = "realizar_captura";
  ...
  public function user_actions(Array $arr) {
    ...
    $result = new \stdClass;
    $result->success = true ;
    $arr = $this->tools->allowed_actions($captura, $this->workflow_name, $user_email);
    $result->message = $arr;
    return $result;
  }
  ...
  public function actions(Array $arr) {
    ...
    $result = new \stdClass;
    $result->success = true ;
    $arr = $this->tools->get_actions($captura);
    $result->message = $arr;
    return $result;
  }
  ...
  public function dependencia(Captura $captura) {
    $dependencia_id = NULL;
    $d_mp = Captura::whereId($captura->id)->with('institucion.documento.dependencia')->first();
