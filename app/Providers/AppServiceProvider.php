...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        SolicitudEstructuraCriminalSS::saving(function ($solicitud_estructura_criminal_ss) {
             // check has delitos asignados
             $res = $this->tools->SolicitudEstructuraCriminalSSonBeforeTransition($solicitud_estructura_criminal_ss);
             $this->log::alert('$res@::saving is .. ' . var_export($res, true));
             if ($res) {
               // launch other events for other listeners
               $event_name = "solicitud_estructura_criminal_ss_before_transition";
               $result = $this->before_object($event_name, $solicitud_estructura_criminal_ss);
             }
             return $res;
        });

        SolicitudEstructuraCriminalSS::saved(function ($solicitud_estructura_criminal_ss) {
             $event_name = "solicitud_estructura_criminal_ss_after_transition";
             $res = $this->after_object($event_name, $solicitud_estructura_criminal_ss);
        });
    }
